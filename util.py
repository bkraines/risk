...
def select_date_range(
    ...
    static_ranges = {
        "max": (default_start, default_end),
        "custom": None,
    }

    trailing_ranges = {
        label: (get_start_date_n_periods_ago(n), default_end)
    ...
    if selected_range != "custom":
        ...
        start_date = st.date_input("Start date", default_end, min_value=default_start, max_value=default_end)
